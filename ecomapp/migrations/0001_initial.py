# Generated by Django 4.2.1 on 2023-06-01 13:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('Bahawalpur', 'Bahawalnagar'), ('Rahim Yar Khan', 'Gujranwala'), ('Gujrat', 'Sargodha'), ('Khushab', 'Mianwali'), ('Bhakkar', 'Sahiwal'), ('Pakpattan', 'Okara')], max_length=250)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('M', 'Mobile'), ('L', 'LAptop'), ('S', 'Shoes'), ('J', 'Jeans'), ('ST', 'Shirts')], max_length=50)),
